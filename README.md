...
│   ├── assets/
│   │   ├── ai-summary/     # OpenRouter ポートフォリオ AI サマリー
│   │   └── news/           # 保有資産ニュース取得
...
features/
├── ai/
│   ├── components/         # AI 分析フロー、エキスパートカード、意思決定バナー
│   └── lib/                # AI プロンプト定義・Function Calling ツール・型定義
├── assets/
│   ├── components/         # 資産フォーム、K線図、収益統計
│   └── hooks/              # 資産計算および取引ロジック Hooks
└── stocks/
    └── components/         # TradingView 各種コンポーネント
```
