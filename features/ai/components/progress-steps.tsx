...
export function ProgressSteps({
  ...
  const STEPS = [
    { id: "analysis start", label: t("fetchingData") },
    {
      id: "agent1",
      label: personas[0] ? PERSONA_META[personas[0]].name : t("analyst1"),
    },
    {
      id: "agent2",
      label: personas[1] ? PERSONA_META[personas[1]].name : t("analyst2"),
    },
